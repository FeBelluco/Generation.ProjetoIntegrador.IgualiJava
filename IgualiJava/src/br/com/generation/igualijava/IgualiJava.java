...
public class IgualiJava {
	...
	public static void main(String[] args) {
		...
		etniaArray.add("(2)Pardo");
		etniaArray.add("(3)Indigena");
		etniaArray.add("(4)Branco");
		etniaArray.add("(5)Prefiro não dizer.");

		orientaS.add("(1)Homossexual");
		orientaS.add("(2)Lésbica");
		orientaS.add("(3)Bissexual");
		orientaS.add("(4)PanSexual");
		orientaS.add("(5)Assexual");
		orientaS.add("(6)Hétero");
		orientaS.add("(7)Prefiro não dizer.");

		identidadeGenero.add("(1)Cisgênero");
		identidadeGenero.add("(2)Não-Binário");
		identidadeGenero.add("(3)Travesti");
		identidadeGenero.add("(4)Mulher Trans");
		identidadeGenero.add("(5)Homem Trans");
		identidadeGenero.add("(6)Prefiro não dizer.");

		System.out.println("********************************************");
		System.out.println("**                                        **");
		System.out.println("**              IgualiJava!               **");
		System.out.println("**                                        **");
		System.out.println("**    Dando um desconto pra sua VIDA!     **");
		System.out.println("********************************************");
		System.out.println();
		...
		if (m != 1 && m != 2 && m != 3 && m != 4 && m != 5 ) {
			System.out.println("Opção inválida. Recomece todas as etapas.");
			System.exit(m);
		}
		...
		else if (pe1.getOrientSexo() == "(2)Lésbica") {
			descontoOrientacaoSexual = 5;
		} 
		else if (pe1.getOrientSexo() == "(3)Bissexual") {
			descontoOrientacaoSexual = 5;
		} 
		else if (pe1.getOrientSexo() == "(4)PanSexual") {
			descontoOrientacaoSexual = 5;
		} 
		else if (pe1.getOrientSexo() == "(5)Assexual") {
			descontoOrientacaoSexual = 5;
		} 
		else if (pe1.getOrientSexo() == "(6)Hétero") {
			descontoOrientacaoSexual = 0;
		} 
		else if (pe1.getOrientSexo() == "(7)Prefiro não dizer.") {
			descontoOrientacaoSexual = 0;
			System.out.println("Infelizmente não vamos poder contalizar"
					+ " seu desconto desta etapa. É importante detalhar todas as condições."
					+ "\nMas sem problemas! Continue nas próximas etapas, e faremos o cálculo total.");
		...
		else if (pe1.getIdentiGenero() == "(4)Mulher Trans") {
			descontoIdentidade = 5;
		}
		else if (pe1.getIdentiGenero() == "(5)Homem Trans") {
			descontoIdentidade = 5;
		}
		else if (pe1.getIdentiGenero() == "(6)Prefiro não dizer.") {
		...
		pagar = conta - s;
		System.out.printf("Valor a pagar é  %.2f: ", pagar);
		System.out.println();
